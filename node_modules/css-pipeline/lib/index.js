...
(function() {
  var CleanCSS, RootsUtil, crypto, fs, minimatch, path, yaml, _;
      ...
      function CSSPipeline(roots) {
        ...
        this.roots.config.locals.css = (function(_this) {
          return function(prefix) {
            var matcher, paths, _i, _len, _ref;
            if (prefix == null) {
              prefix = '';
            }
            paths = [];
      ...
      CSSPipeline.prototype.category_hooks = function() {
        return {
          after: (function(_this) {
            return function(ctx) {
              var all_contents, content, file, hash, matcher, res, _i, _len, _ref, _ref1;
              if (!opts.out) {
                return;
              }
              all_contents = '';
